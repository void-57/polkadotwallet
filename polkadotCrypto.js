(function (EXPORTS) {
  ...
  // Base58 alphabet for Substrate/Polkadot addresses
  ...
  // Blake2b hash function for Polkadot addresses
  ...
  // Create Polkadot SS58 address from public key
  function createPolkadotAddress(publicKey, ss58Prefix = 0) {
    ...
    const checksumInput = new Uint8Array([...new TextEncoder().encode('SS58PRE'), ...payload]);
